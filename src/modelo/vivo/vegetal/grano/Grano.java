package modelo.vivo.vegetal.grano;
...
public class Grano extends Planta{
     ...
     */
    public Grano(String nombre, int precio, int cantidadDeSemillasParaPlantar, int alimentosGenerados, int puntosDeVidaGenerados) {
